export default function contact(){
    return(
        ...
        <p className="contactDescription">If you'd like to work together, ask a question, or just say hello — feel free to <span>click the links below</span> to get in touch. I’d love to hear from you!</p>
        <img/>
        <ul className="contactSocials">
            ...
            <li>
           <a href="https://github.com/jacobchase" target="_blank" rel="noopener"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg"/> </a>
          </li>
        </ul>
        </div>
        </div>
